...
public:
	...
	void initBorder1(); //Initializes the Border Vector map 1
	...
	NextState  switchState() override; //Determines if the User lost or wants to quit
...
private:
	...
	//Counter For Tail and Fruit Collision
	double counterTF;
